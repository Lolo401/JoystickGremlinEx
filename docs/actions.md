...
| Map to Stream Deck | Select a connected Stream Deck and run Change / Next / Previous Page or Return to Last via the plugin bridge | Use with the [Stream Deck plugin bridge](streamdeck.md) |
